angular.module("ForecastApp", [])
            ...
            wsc.getLatLonForSelected = function(){
                GoogleGeolocationService.geoLocate(wsc.selected_city)
                    .then(function(res){
                        ...
                        var google_static_maps_key = "AIzaSyCGtE8_YZEWZPpB5Fkg8WJcTSZQm86nK1M";
            ...
            wsc.getCurrentConditions = function(){
                DarkSkyWeatherService.getCurrentConditions(wsc.selected_city)
                    .then(function(res){
                        ...
                        wsc.humidity         = res.data.currently.humidity;
                        wsc.precipProbability= (res.data.currently.precipProbability/100 * 100) + "%";
    ...
    .factory('DarkSkyWeatherService',['$sce', '$http', 
        function($sce, $http){
            ...
            //DarkSky API key
            var key = "19884f487b1a3b208ad1167d5f61bd1a";
